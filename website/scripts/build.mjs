...
export function configuration(env = process.env) {
  ...
  return {siteUrl:url.origin+'/',indexable,gaId};
}
export async function build(env=process.env) {
  ...
  content.push({path:'/404.html',title:'Page not found',description:'This Fehm page could not be found. Return to the documentation or installation guide.',body:'<header class="page-intro"><p class="eyebrow">404 / NO CONNECTION FOUND</p><h1>This path ends here.</h1><p class="lead">The page may have moved. Start again with the <a href="/docs/">documentation</a> or <a href="/">home page</a>.</p></header>'});
